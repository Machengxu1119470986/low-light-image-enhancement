...
#sample_dir = './results/fivekdataset_xxxeval15/'
sample_dir = './results/LOLdataset_attxinxinxin_eval15/'
...
for idx in range(len(eval_low_data)):
    ...
    input_sm = eval_low_data[idx]
    input_s_eval = np.expand_dims(input_sm, axis=0)
    ...
    restoration_r = sess.run(output_r, feed_dict={input_low_r: decom_r_low, input_low_i: decom_i_low, input_ss:input_s_eval})
    ...
    #fusion = (restoration_r*1.2)*(adjust_i*0.83)
